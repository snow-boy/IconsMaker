...
//            }
            ...
            entries[i].bHeight = image.height() < 256?image.height():0;
            entries[i].bWidth = image.width() < 256?image.width():0;
            ...
            bmpHeaders[i].biHeight = image.height() * 2; // 2 is for the mask
            ...
            bmpHeaders[i].biWidth = image.width();
